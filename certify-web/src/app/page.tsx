...
const plans = [
  ...
  { ...PLAN_PRICING.pro, tag: "الأكثر اختيارا", features: [`حتى ${PLAN_PRICING.pro.teamLabel}`, "كل ميزات المجاني", "إصدار جماعي من Excel", "توقيع رقمي مخصص", "تتبع مشاهدات وتحميلات الشهادة"], cta: "ابدأ الآن", highlight: true },
