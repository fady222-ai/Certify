...
- **القالب الموجّه + لوحة «محتوى الشهادة»:** القالب 21 (الشعار أعلى → «شهادة» → جملة الأكاديمية →
  ...
  و`role:"body"`. المحرّر (`TemplateEditor.tsx`) يكتشفهما ويعرض لوحة **«محتوى الشهادة»**: قائمة
  **نوع الشهادة** (`CERT_TYPES`) تجعل العنوان «شهادة حضور/تقدير/…» (تُشتقّ القيمة من نصّ العنوان)،
  و**نصّ الشهادة** (`textarea`) لتعديل الجملة. تحكّم وقت التصميم يُحفظ في القالب. `canvas.ts`
